...
public class BrightnessLevelPreferenceController extends AbstractPreferenceController implements
    ...
    private double getCurrentBrightness() {
	    ...
	    value = Settings.System.getInt(mContentResolver,System.SCREEN_BRIGHTNESS_FOR_VR, mMaxBrightness);//brightness modify
        } else {
	    ...
	    value = Settings.System.getInt(mContentResolver,System.SCREEN_BRIGHTNESS, mMinBrightness);//brightness modify
        }
	//return getPercentage(value, 0, GAMMA_SPACE_MAX);
        return getPercentage(value, mMinBrightness, mMaxBrightness);//brightness modify
    }
