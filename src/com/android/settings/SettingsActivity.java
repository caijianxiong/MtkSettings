...
//add for ethernet settings start
...
public class SettingsActivity extends SettingsBaseActivity
    ...
    private void doUpdateTilesList() {
        ...
        //add for ethernet settings start
        somethingChanged = setTileEnabled(changedList,
				new ComponentName(packageName,Settings.EthernetSettingsActivity.class.getName()),
                FeatureOption.MTK_ALPS_ETHERNET_EXT, isAdmin) || somethingChanged;;
        //add for ethernet settings end
        ...
        somethingChanged = setTileEnabled(changedList, new ComponentName(packageName,
                ...
                // WifiDisplaySettings.isAvailable(this), 
                false,
                isAdmin)
                || somethingChanged;
