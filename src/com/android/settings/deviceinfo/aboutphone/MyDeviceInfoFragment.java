...
import com.android.settings.deviceinfo.HdmiResolutionPreferenceController;
...
import com.android.settings.deviceinfo.SerialNumberPreferenceController;// add Serial Number
...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        return buildPreferenceControllers(context,getActivity(), this /* fragment */, getSettingsLifecycle());
    }
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
        ...
        controllers.add(new HdmiResolutionPreferenceController(context, lifecycle));
        //Added by gjw end
        controllers.add(new SerialNumberPreferenceController(context)); //add serial number
        ...
        controllers.add(new CustomizeBuildVersionPreferenceController(context, activity, lifecycle));
