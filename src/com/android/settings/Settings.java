...
public class Settings extends SettingsActivity {
    ...
    */
    public static class EthernetSettingsActivity extends SettingsActivity { /* empty */ }//add for ethernet settings
    ...
    public static class NetworkDashboardActivity extends SettingsActivity {
        private static final String EXTRA_AUTO_FINISH = "auto_finish";
        private boolean mRegisterBr = false;
        ...
        protected void onResume() {
            ...
            if (getIntent().getBooleanExtra(EXTRA_AUTO_FINISH, false)) {
                getIntent().removeExtra(EXTRA_AUTO_FINISH);
